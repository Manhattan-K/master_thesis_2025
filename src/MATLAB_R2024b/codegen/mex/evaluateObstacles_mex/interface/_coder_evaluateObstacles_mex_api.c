 ...
 *
 * _coder_evaluateObstacles_mex_api.c
 *
 * Code generation for function '_coder_evaluateObstacles_mex_api'
 *
 */
...
static void ab_emlrt_marshallIn(const mxArray *u,
...
static d_rtString bb_emlrt_marshallIn(const mxArray *u,
                                      const emlrtMsgIdentifier *parentId);

static void bc_emlrt_marshallIn(const mxArray *src,
                                const emlrtMsgIdentifier *msgId, real_T ret[6]);

static void c_emlrt_marshallIn(const mxArray *nullptr, const char_T *identifier,
                               struct0_T y_data[], int32_T y_size[2]);

static const mxArray *c_emlrt_marshallOut(const emxArray_real_T *u);

static void cb_emlrt_marshallIn(const mxArray *u,
                                const emlrtMsgIdentifier *parentId,
                                char_T y[4]);
...
static e_rtString db_emlrt_marshallIn(const mxArray *u,
                                      const emlrtMsgIdentifier *parentId);
...
static rtString f_emlrt_marshallIn(const mxArray *u,
                                   const emlrtMsgIdentifier *parentId);
...
static void gb_emlrt_marshallIn(const mxArray *u,
                                const emlrtMsgIdentifier *parentId,
                                real_T y[20]);
...
static struct3_T hb_emlrt_marshallIn(const mxArray *nullptr,
                                     const char_T *identifier);
...
static boolean_T i_emlrt_marshallIn(const mxArray *u,
                                    const emlrtMsgIdentifier *parentId);

static const mxArray *i_emlrt_marshallOut(real_T u[4]);

static struct3_T ib_emlrt_marshallIn(const mxArray *u,
                                     const emlrtMsgIdentifier *parentId);
...
static real_T (*j_emlrt_marshallIn(const mxArray *nullptr,
...
static void l_emlrt_marshallIn(const mxArray *nullptr, const char_T *identifier,
                               struct1_T *y);
...
static b_rtString o_emlrt_marshallIn(const mxArray *u,
                                     const emlrtMsgIdentifier *parentId);
...
static c_rtString q_emlrt_marshallIn(const mxArray *u,
                                     const emlrtMsgIdentifier *parentId);
...
static real_T vb_emlrt_marshallIn(const mxArray *src,
                                  const emlrtMsgIdentifier *msgId);
...
static void x_emlrt_marshallIn(const mxArray *u,
                               const emlrtMsgIdentifier *parentId,
                               real_T y_data[], int32_T y_size[2]);

static void xb_emlrt_marshallIn(const mxArray *src,
                                const emlrtMsgIdentifier *msgId, real_T ret[2]);

static void y_emlrt_marshallIn(const mxArray *nullptr, const char_T *identifier,
                               struct2_T *y);
                                      ...
                                      const emlrtMsgIdentifier *parentId)
{
  ...
  cb_emlrt_marshallIn(emlrtAlias(propValues), &thisId, y.Value);
                               ...
                               struct0_T y_data[], int32_T y_size[2])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  d_emlrt_marshallIn(emlrtAlias(nullptr), &thisId, y_data, y_size);
                                      ...
                                      const emlrtMsgIdentifier *parentId)
{
  ...
  emlrtGetAllProperties(emlrtRootTLSGlobal, u, 0, 1,
                        ...
                        (const char_T **)&propClasses, &propValues);
  thisId.fIdentifier = "Value";
  eb_emlrt_marshallIn(emlrtAlias(propValues), &thisId, y.Value);
  emlrtDestroyArrays(1, &propValues);
  emlrtDestroyArray(&u);
  return y;
}
                                   ...
                                   const emlrtMsgIdentifier *parentId)
{
  ...
  emlrtGetAllProperties(emlrtRootTLSGlobal, u, 0, 1,
                        ...
                        (const char_T **)&propClasses, &propValues);
  thisId.fIdentifier = "Value";
  g_emlrt_marshallIn(emlrtAlias(propValues), &thisId, y.Value);
  emlrtDestroyArrays(1, &propValues);
  emlrtDestroyArray(&u);
  return y;
}
                                     ...
                                     const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = ib_emlrt_marshallIn(emlrtAlias(nullptr), &thisId);
  emlrtDestroyArray(&nullptr);
  return y;
}
                                   ...
                                   const char_T *identifier))[2]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = k_emlrt_marshallIn(emlrtAlias(nullptr), &thisId);
  emlrtDestroyArray(&nullptr);
  return y;
}
                               ...
                               struct1_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  m_emlrt_marshallIn(emlrtAlias(nullptr), &thisId, y);
  emlrtDestroyArray(&nullptr);
}
                               ...
                               const emlrtMsgIdentifier *parentId, struct1_T *y)
{
  ...
  y->w_max = b_emlrt_marshallIn(
      ...
      &thisId);
  thisId.fIdentifier = "pos_color";
  y->pos_color = o_emlrt_marshallIn(
      emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 3, "pos_color")),
      &thisId);
  thisId.fIdentifier = "pred_color";
  y->pred_color =
      q_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u,
                                                        0, 4, "pred_color")),
                         &thisId);
  thisId.fIdentifier = "constraint_color";
  y->constraint_color =
      f_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(
  ...
  y->keep_predictions =
      i_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(
                         ...
                         &thisId);
  thisId.fIdentifier = "initRobotShape";
  s_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 9,
                                                    "initRobotShape")),
                     &thisId, y->initRobotShape);
  thisId.fIdentifier = "robotShape";
                                     ...
                                     const emlrtMsgIdentifier *parentId)
{
  ...
  emlrtGetAllProperties(emlrtRootTLSGlobal, u, 0, 1,
                        ...
                        (const char_T **)&propClasses, &propValues);
  thisId.fIdentifier = "Value";
  p_emlrt_marshallIn(emlrtAlias(propValues), &thisId, y.Value);
  emlrtDestroyArrays(1, &propValues);
  emlrtDestroyArray(&u);
  return y;
}
                                     ...
                                     const emlrtMsgIdentifier *parentId)
{
  ...
  emlrtGetAllProperties(emlrtRootTLSGlobal, u, 0, 1,
                        ...
                        (const char_T **)&propClasses, &propValues);
  thisId.fIdentifier = "Value";
  r_emlrt_marshallIn(emlrtAlias(propValues), &thisId, y.Value);
  emlrtDestroyArrays(1, &propValues);
  emlrtDestroyArray(&u);
  return y;
}
...
static void x_emlrt_marshallIn(const mxArray *u,
                               ...
                               real_T y_data[], int32_T y_size[2])
{
  jc_emlrt_marshallIn(emlrtAlias(u), parentId, y_data, y_size);
  emlrtDestroyArray(&u);
}
                               ...
                               struct2_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  ab_emlrt_marshallIn(emlrtAlias(nullptr), &thisId, y);
  emlrtDestroyArray(&nullptr);
}
...
void evaluateObstacles_api(const mxArray *const prhs[7], const mxArray **plhs)
{
  ...
  /* Marshall function inputs */
  c_emlrt_marshallIn(emlrtAliasP(prhs[0]), "obstacles", obstacles_data,
                     obstacles_size);
  x_l = j_emlrt_marshallIn(emlrtAlias(prhs[1]), "x_l");
  x_f = j_emlrt_marshallIn(emlrtAlias(prhs[2]), "x_f");
  l_emlrt_marshallIn(emlrtAliasP(prhs[3]), "leaderParams", &leaderParams);
  y_emlrt_marshallIn(emlrtAliasP(prhs[4]), "followerParams", &followerParams);
  sys = hb_emlrt_marshallIn(emlrtAliasP(prhs[5]), "sys");
...
void followerMPCandUpdate_api(evaluateObstacles_mexStackData *SD,
                              ...
                              const mxArray *plhs[5])
{
  ...
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  /* Marshall function inputs */
  sys = hb_emlrt_marshallIn(emlrtAliasP(prhs[0]), "sys");
  ...
  y_emlrt_marshallIn(emlrtAliasP(prhs[4]), "robotParams", &robotParams);
  emxInitStruct_struct5_T(&obstacles);
  nb_emlrt_marshallIn(emlrtAliasP(prhs[5]), "obstacles", &obstacles);
  U_f_old = tb_emlrt_marshallIn(emlrtAlias(prhs[6]), "U_f_old");
  /* Invoke the target function */
  emxInit_real_T(&p_tp1, 1);
  emxInit_real_T(&X_F, 2);
  followerMPCandUpdate(SD, &sys, *x0, *X_L_stacked, N, &robotParams, &obstacles,
                       *U_f_old, p_tp1, X_F, &c_error, *u_t, *u_opt);
  emxFreeStruct_struct5_T(&obstacles);
  /* Marshall function outputs */
  ...
  emxFree_real_T(&X_F);
  if (nlhs > 2) {
    plhs[2] = f_emlrt_marshallOut(c_error);
  }
  if (nlhs > 3) {
...
void leaderMPCandUpdateHalt_api(evaluateObstacles_mexStackData *SD,
                                ...
                                const mxArray *plhs[6])
{
  ...
  l_emlrt_marshallIn(emlrtAliasP(prhs[3]), "robotParams",
                     &SD->u3.f5.robotParams);
  emxInitStruct_struct5_T(&obstacles);
  nb_emlrt_marshallIn(emlrtAliasP(prhs[4]), "obstacles", &obstacles);
  U_l_old = tb_emlrt_marshallIn(emlrtAlias(prhs[5]), "U_l_old");
  /* Invoke the target function */
  emxInit_real_T(&p_tp1, 1);
  emxInit_real_T(&X_L, 2);
  emxInit_real_T(&X_L_stacked, 1);
  leaderMPCandUpdateHalt(SD, &sys, *x0, N, &SD->u3.f5.robotParams, &obstacles,
                         *U_l_old, p_tp1, X_L, X_L_stacked, &c_error, *u_t,
                         *u_opt);
  emxFreeStruct_struct5_T(&obstacles);
  /* Marshall function outputs */
  p_tp1->canFreeData = false;
  ...
  if (nlhs > 3) {
    plhs[3] = f_emlrt_marshallOut(c_error);
  }
  if (nlhs > 4) {
...
void leaderMPCandUpdate_api(evaluateObstacles_mexStackData *SD,
                            const mxArray *const prhs[6], int32_T nlhs,
                            const mxArray *plhs[6])
{
  emxArray_real_T *X_L;
  ...
  emxInit_real_T(&X_L, 2);
  emxInit_real_T(&X_L_stacked, 1);
  leaderMPCandUpdate(SD, &sys, *x0, N, &SD->u3.f4.robotParams, &obstacles,
...
/* End of code generation (_coder_evaluateObstacles_mex_api.c) */
