 ...
 *
 * evaluateObstacles_mex_initialize.c
 *
 * Code generation for function 'evaluateObstacles_mex_initialize'
 *
 */
...
static void evaluateObstacles_mex_once(void);
...
void evaluateObstacles_mex_initialize(void)
{
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    evaluateObstacles_mex_once();
  }
  emlrtCheckProfilerStatus();
}

/* End of code generation (evaluateObstacles_mex_initialize.c) */
