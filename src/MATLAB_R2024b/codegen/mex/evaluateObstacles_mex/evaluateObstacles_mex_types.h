...
#ifndef struct_emxArray_real_T_80x40
#define struct_emxArray_real_T_80x40
struct emxArray_real_T_80x40 {
  real_T data[3200];
  int32_T size[2];
};
#endif /* struct_emxArray_real_T_80x40 */
#ifndef typedef_emxArray_real_T_80x40
#define typedef_emxArray_real_T_80x40
typedef struct emxArray_real_T_80x40 emxArray_real_T_80x40;
#endif /* typedef_emxArray_real_T_80x40 */
...
typedef struct {
  ...
  real_T W_hat[3600];
  real_T R_hat[1600];
  emxArray_real_T_80x40 lb;
  emxArray_real_T_80x40 ub;
} struct1_T;
...
#ifndef struct_emxArray_int32_T_14801
#define struct_emxArray_int32_T_14801
struct emxArray_int32_T_14801 {
  int32_T data[14801];
  int32_T size[1];
};
#endif /* struct_emxArray_int32_T_14801 */
#ifndef typedef_emxArray_int32_T_14801
#define typedef_emxArray_int32_T_14801
typedef struct emxArray_int32_T_14801 emxArray_int32_T_14801;
#endif /* typedef_emxArray_int32_T_14801 */
...
#ifndef struct_emxArray_boolean_T_14801
#define struct_emxArray_boolean_T_14801
struct emxArray_boolean_T_14801 {
  boolean_T data[14801];
  int32_T size[1];
};
#endif /* struct_emxArray_boolean_T_14801 */
#ifndef c_typedef_emxArray_boolean_T_14
#define c_typedef_emxArray_boolean_T_14
typedef struct emxArray_boolean_T_14801 emxArray_boolean_T_14801;
#endif /* c_typedef_emxArray_boolean_T_14 */
...
typedef struct {
  ...
  emxArray_int32_T_14801 workspace_int;
  emxArray_int32_T_14801 workspace_sort;
} e_struct_T;
...
typedef struct {
  c_anonymous_function value;
  s_coder_internal_stickyStruct next;
...
typedef struct {
  ...
  emxArray_int32_T_14801 workingset_old;
...
typedef struct {
  ...
  emxArray_boolean_T_14801 isActiveConstr;
  emxArray_int32_T_14801 Wid;
  emxArray_int32_T_14801 Wlocalidx;
  int32_T nWConstr[5];
  int32_T probType;
  real_T SLACK0;
} k_struct_T;
...
typedef struct {
  d_anonymous_function objfun;
  c_anonymous_function nonlin;
  real_T f_1;
...
#ifndef c_typedef_evaluateObstacles_mex
#define c_typedef_evaluateObstacles_mex
typedef struct {
  ...
  union {
    b_leaderMPCandUpdate_api f4;
    b_leaderMPCandUpdateHalt_api f5;
  } u3;
} evaluateObstacles_mexStackData;
#endif /* c_typedef_evaluateObstacles_mex */

/* End of code generation (evaluateObstacles_mex_types.h) */
