                 ...
                 const real_T ub_data[], const int32_T ub_size[2])
{
  ...
  computeGradLag(TrialState->gradLag.data, WorkingSet->ldA, WorkingSet->nVar,
                 TrialState->grad.data, WorkingSet->sizes[2], WorkingSet->Aineq,
  ...
  MeritFunction->nlpPrimalFeasError = computePrimalFeasError(
      ...
      TrialState->mNonlinIneq, TrialState->cIneq.data, WorkingSet->indexLB.data,
      WorkingSet->sizes[3], lb_data, WorkingSet->indexUB.data,
      WorkingSet->sizes[4], ub_data);
  ...
  if (!Flags->gradOK) {
    ...
    MeritFunction->nlpComplError = computeComplError(
        ...
        WorkingSet->sizes[3], lb_data, WorkingSet->indexUB.data,
        WorkingSet->sizes[4], ub_data, TrialState->lambdaStopTest,
    ...
    if (TrialState->sqpIterations > 1) {
      b_computeGradLag(memspace->workspace_float, WorkingSet->ldA,
              ...
              if (WorkingSet->nActiveConstr == 0) {
                ...
                if (TrialState->mNonlinIneq > 0) {
                  b_updateWorkingSetForNewQP(
                      ...
                      WorkingSet->sizes[3], lb_data, lb_size,
                ...
                b_computeGradLag(memspace->workspace_float, WorkingSet->ldA,
                                 nVar_tmp, TrialState->grad.data, mIneq,
                                 WorkingSet->Aineq, WorkingSet->indexFixed.data,
                                 mFixed, WorkingSet->indexLB.data, mLB,
                ...
                nlpComplErrorTmp = computeComplError(
                    ...
                    TrialState->cIneq.data, WorkingSet->indexLB.data, mLB,
                    lb_data, WorkingSet->indexUB.data, mUB, ub_data,
