...
real_T b_linesearch(emlrtCTX aTLS, boolean_T *evalWellDefined,
                    int32_T WorkingSet_nVar, int32_T WorkingSet_ldA,
                    const emxArray_real_T *WorkingSet_Aineq,
                    h_struct_T *TrialState, real_T MeritFunction_penaltyParam,
                    ...
                    boolean_T socTaken, int32_T *exitflag)
{
  ...
  real_T phi_alpha;
  real_T *y_data;
  int32_T b_linesearch_numThreads;
  int32_T b_loop_ub;
  int32_T i;
  int32_T idx;
  int32_T loop_ub;
  ...
  *exitflag = 1;
  ...
  if (loop_ub < 1200) {
    ...
    b_linesearch_numThreads = emlrtAllocRegionTLSs(
        aTLS, omp_in_parallel(), omp_get_max_threads(), omp_get_num_procs());
#pragma omp parallel for num_threads(b_linesearch_numThreads)
  ...
  do {
    ...
    if (TrialState->FunctionEvaluations < 4000) {
      if ((*evalWellDefined) &&
        ...
        boolean_T tooSmallX;
        alpha *= 0.7;
        loop_ub = (uint16_T)WorkingSet_nVar;
        b_loop_ub = ((uint16_T)WorkingSet_nVar >> 2) << 2;
        vectorUB_tmp = b_loop_ub - 4;
        ...
        for (idx = b_loop_ub; idx < loop_ub; idx++) {
        ...
        if (tooSmallX) {
          *exitflag = -2;
          ...
          if (loop_ub == 1) {
            loop_ub = b_computeConstraints_(
                aTLS, c_FcnEvaluator_next_next_next_n,
          ...
          *evalWellDefined = (loop_ub == 1);
          if (*evalWellDefined) {
            phi_alpha = 0.0;
            loop_ub = (uint16_T)TrialState->mIneq;
...
real_T c_linesearch(emlrtCTX aTLS, boolean_T *evalWellDefined,
                    int32_T WorkingSet_nVar, int32_T WorkingSet_ldA,
                    const emxArray_real_T *WorkingSet_Aineq,
                    h_struct_T *TrialState, real_T MeritFunction_penaltyParam,
                    real_T MeritFunction_phi, real_T MeritFunction_phiPrimePlus,
                    ...
                    real_T f_FcnEvaluator_next_next_next_n,
                    const struct3_T g_FcnEvaluator_next_next_next_n,
                    const d_struct_T *h_FcnEvaluator_next_next_next_n,
                    boolean_T socTaken, int32_T *exitflag)
{
  ptrdiff_t incx_t;
  ptrdiff_t incy_t;
  ...
  real_T *y_data;
  int32_T b_loop_ub;
  int32_T c_linesearch_numThreads;
  int32_T i;
  int32_T idx;
  int32_T loop_ub;
  int32_T mLinIneq;
  ...
  *exitflag = 1;
  ...
  if (loop_ub < 1200) {
    ...
    emlrtEnterParallelRegion(aTLS, omp_in_parallel());
    emlrtPushJmpBuf(aTLS, &emlrtJBStack);
    c_linesearch_numThreads = emlrtAllocRegionTLSs(
        aTLS, omp_in_parallel(), omp_get_max_threads(), omp_get_num_procs());
#pragma omp parallel for num_threads(c_linesearch_numThreads)
        ...
        if (tooSmallX) {
          *exitflag = -2;
          ...
          phi_alpha = leaderMPCandUpdateHalt_anonFcn1(
              aTLS, h_FcnEvaluator_next_next_next_n->x0,
              h_FcnEvaluator_next_next_next_n->sys.n,
              h_FcnEvaluator_next_next_next_n->sys.Ts,
...
real_T linesearch(emlrtCTX aTLS, boolean_T *evalWellDefined,
                  int32_T WorkingSet_nVar, int32_T WorkingSet_ldA,
                  const emxArray_real_T *WorkingSet_Aineq,
                  h_struct_T *TrialState, real_T MeritFunction_penaltyParam,
                  real_T MeritFunction_phi, real_T MeritFunction_phiPrimePlus,
                  ...
                  real_T f_FcnEvaluator_next_next_next_n,
                  const struct3_T g_FcnEvaluator_next_next_next_n,
                  const b_struct_T *h_FcnEvaluator_next_next_next_n,
                  boolean_T socTaken, int32_T *exitflag)
{
  ptrdiff_t incx_t;
  ptrdiff_t incy_t;
  ...
  *exitflag = 1;
  ...
  emxEnsureCapacity_real_T(y, loop_ub);
  y_data = y->data;
  b_loop_ub = TrialState->searchDir.size[0];
  if (b_loop_ub < 1200) {
    for (i = 0; i < b_loop_ub; i++) {
      y_data[i] = TrialState->searchDir.data[i];
    }
    ...
    emlrtEnterParallelRegion(aTLS, omp_in_parallel());
    emlrtPushJmpBuf(aTLS, &emlrtJBStack);
    linesearch_numThreads = emlrtAllocRegionTLSs(
        aTLS, omp_in_parallel(), omp_get_max_threads(), omp_get_num_procs());
#pragma omp parallel for num_threads(linesearch_numThreads)
  ...
  do {
    ...
    if (TrialState->FunctionEvaluations < 4000) {
      if ((*evalWellDefined) &&
        ...
        alpha *= 0.7;
        loop_ub = (uint16_T)WorkingSet_nVar;
        scalarLB_tmp = ((uint16_T)WorkingSet_nVar >> 2) << 2;
        b_loop_ub = scalarLB_tmp - 4;
        for (idx = 0; idx <= b_loop_ub; idx += 4) {
          r = _mm256_loadu_pd(&TrialState->xstar.data[idx]);
          _mm256_storeu_pd(&TrialState->delta_x.data[idx],
                           _mm256_mul_pd(_mm256_set1_pd(alpha), r));
        }
        for (idx = scalarLB_tmp; idx < loop_ub; idx++) {
          TrialState->delta_x.data[idx] = alpha * TrialState->xstar.data[idx];
        }
        if (socTaken) {
          phi_alpha = alpha * alpha;
        ...
        if (tooSmallX) {
          *exitflag = -2;
          ...
          scalarLB_tmp = TrialState->cIneq.size[0];
          b_loop_ub = TrialState->cIneq.size[0];
          if (b_loop_ub - 1 >= 0) {
          ...
          if (scalarLB_tmp - 1 >= 0) {
            memcpy(&TrialState->cIneq.data[0], &workspaceIneq_data[0],
                   (uint32_T)scalarLB_tmp * sizeof(real_T));
          }
          TrialState->FunctionEvaluations++;
          *evalWellDefined = (loop_ub == 1);
          if (*evalWellDefined) {
