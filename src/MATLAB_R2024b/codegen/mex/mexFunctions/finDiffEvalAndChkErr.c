  ...
  *fplus = leaderMPCandUpdate_anonFcn1(
  ...
  if (evalOK) {
    ...
    *cIneqPlus_size = constraints(
        emlrtRootTLSGlobal, xk, obj_nonlin_workspace_x0,
        c_obj_nonlin_workspace_obstacle, d_obj_nonlin_workspace_obstacle,
        e_obj_nonlin_workspace_obstacle, f_obj_nonlin_workspace_obstacle,
        obj_nonlin_workspace_N, obj_nonlin_workspace_sys_n,
        obj_nonlin_workspace_sys_Ts, cIneqPlus_data);
    ...
    int32_T dim, real_T delta, real_T xk[40], real_T *fplus)
{
  ...
  *fplus = leaderMPCandUpdateHalt_anonFcn1(
      emlrtRootTLSGlobal, obj_objfun_workspace_x0, obj_objfun_workspace_sys_n,
  ...
  *fplus = followerMPCandUpdate_anonFcn1(
  ...
  if (evalOK) {
    ...
    *cIneqPlus_size = followerMPCandUpdate_anonFcn2(
        emlrtRootTLSGlobal, obj_nonlin_workspace_x0,
        c_obj_nonlin_workspace_obstacle, d_obj_nonlin_workspace_obstacle,
        e_obj_nonlin_workspace_obstacle, f_obj_nonlin_workspace_obstacle,
        obj_nonlin_workspace_N, obj_nonlin_workspace_sys_n,
        obj_nonlin_workspace_sys_Ts, xk, cIneqPlus_data);
    idx = 0;
    while (evalOK && (idx + 1 <= obj_mIneq)) {
      evalOK = ((!muDoubleScalarIsInf(cIneqPlus_data[idx])) &&
                (!muDoubleScalarIsNaN(cIneqPlus_data[idx])));
