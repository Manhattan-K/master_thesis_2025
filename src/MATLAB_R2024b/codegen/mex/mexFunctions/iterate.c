               ...
               int32_T runTimeOptions_MaxIterations)
{
  ...
  computeGrad_StoreHx(emlrtRootTLSGlobal, objective, H, f_data,
                      solution->xstar.data);
  solution->fstar = computeFval_ReuseHx(emlrtRootTLSGlobal, objective,
                                        memspace->workspace_float, f_data,
                                        solution->xstar.data);
    ...
    if (solution->state == -5) {
      ...
      if (subProblemChanged) {
        ...
        case -1:
          ...
          break;
        default:
          factorQR(emlrtRootTLSGlobal, qrmanager, workingset->ATwset, nVar_tmp,
                   workingset->nActiveConstr, workingset->ldA);
          computeQ_(emlrtRootTLSGlobal, qrmanager, qrmanager->mrows);
          break;
        }
        compute_deltax(emlrtRootTLSGlobal, H, solution, memspace, qrmanager,
                       cholmanager, objective, b_strcmp(options_SolverName));
        if (solution->state != -5) {
          exitg1 = 1;
          ...
          b_checkStoppingAndUpdateFval(
              emlrtRootTLSGlobal, &activeSetChangeID, solution, memspace,
      ...
      if (guard1) {
        compute_lambda(emlrtRootTLSGlobal, memspace->workspace_float, solution,
                       objective, qrmanager);
        ...
        updateFval = false;
        b_checkStoppingAndUpdateFval(emlrtRootTLSGlobal, &activeSetChangeID,
      ...
      if (subProblemChanged) {
        ...
        if (solution->state != -5) {
          ...
          computeGrad_StoreHx(emlrtRootTLSGlobal, objective, H, f_data,
                              solution->xstar.data);
          updateFval = true;
          checkStoppingAndUpdateFval(emlrtRootTLSGlobal, &activeSetChangeID,
                                     f_data, solution, memspace, objective,
