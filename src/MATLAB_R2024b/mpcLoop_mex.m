function [x_l, x_f, u_l, u_f, i, X_L_plot, X_F_plot, loadTheta_p, step_time, real_d] = mpcLoop_mex( ...
        goal_reached, max_iter, i, sys, step_time, leaderParams, followerParams, obstacles, ...
        x_l, x_f, u_l, u_f, X_F_plot, X_L_plot, N, U_l_old, U_f_old, policy_halt, delta, loadTheta_p)
